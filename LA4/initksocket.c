...
int main() {
    ...
    */ 
    ...
    sem_SM = semget(K5, 1, 0666 | IPC_CREAT);
    sem_sock_info = semget(K6, 1, 0666 | IPC_CREAT);
    ...
    sem_SM = 1 => Allow only one process to access the shared memory at a time.
    sem_sock_info = 1 => Allow only one process to access the socket info at a time.
    ============================================================================================================
    */
